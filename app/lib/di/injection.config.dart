...
import '../authentication/login/data/service/sign_in_service.dart' as _i15;
import '../authentication/login/data/sign_in_repository.dart' as _i24;
import '../authentication/login/domain/sign_in_interactor.dart' as _i34;
import '../authentication/login/presentation/sign_in_bloc.dart' as _i40;
import '../authentication/network/no_auth_network_module.dart' as _i43;
import '../home/base/network/network_module.dart' as _i42;
import '../home/dashboard/bloc/dashboard_bloc.dart' as _i5;
import '../home/department/department_bloc.dart' as _i41;
import '../home/department/department_interactor.dart' as _i35;
...
import '../home/list/create/market_list_create_service.dart' as _i9;
import '../home/list/create/market_list_home_create_bloc.dart' as _i30;
import '../home/list/detail/market_list_detail_cubit.dart' as _i36;
...
import '../home/list/detail/market_list_detail_service.dart' as _i10;
...
import '../home/list/widget/market_list_view/market_list_view_service.dart'
    as _i11;
import '../home/products/detail/bloc/product_detail_bloc.dart' as _i38;
import '../home/products/detail/data/product_detail_repository.dart' as _i22;
import '../home/products/detail/data/product_detail_service.dart' as _i12;
import '../home/products/detail/domain/product_detail_interactor.dart' as _i32;
import '../home/products/list/bloc/products_bloc.dart' as _i39;
...
import '../home/products/list/products_service.dart' as _i13;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i8.MarketListAddService>(
        () => _i8.MarketListAddServiceImpl(gh<_i7.Dio>()));
    gh.factory<_i9.MarketListCreateService>(
        () => _i9.MarketListCreateServiceImpl(gh<_i7.Dio>()));
    gh.factory<_i10.MarketListDetailService>(
        () => _i10.MarketListDetailServiceImpl(gh<_i7.Dio>()));
    gh.factory<_i11.MarketListViewService>(
        () => _i11.MarketListViewServiceImpl(gh<_i7.Dio>()));
    gh.singleton<_i3.ProductDetailRouteList>(_i3.ProductDetailRouteList());
    gh.factory<_i12.ProductDetailService>(
        () => _i12.ProductDetailServiceImpl(gh<_i7.Dio>()));
    gh.factory<_i13.ProductsService>(
        () => _i13.ProductsServiceImpl(gh<_i7.Dio>()));
    ...
    gh.factory<_i15.SignInService>(
        () => _i15.SignInServiceImpl(gh<_i7.Dio>(instanceName: 'NoAuthDio')));
    gh.factory<_i16.DepartmentService>(
        () => _i16.DepartmentServiceImpl(gh<_i7.Dio>()));
    gh.factory<_i17.MarketListAddRepository>(
        () => _i17.MarketListAddRepositoryImpl(gh<_i8.MarketListAddService>()));
    gh.factory<_i18.MarketListCreateRepository>(() =>
        _i18.MarketListCreateRepositoryImpl(gh<_i9.MarketListCreateService>()));
    gh.factory<_i19.MarketListDetailRepository>(() =>
        _i19.MarketListDetailRepositoryImpl(
            gh<_i10.MarketListDetailService>()));
    ...
    gh.factory<_i21.MarketListViewRepository>(() =>
        _i21.MarketListViewRepositoryImpl(gh<_i11.MarketListViewService>()));
    gh.factory<_i22.ProductDetailRepository>(() =>
        _i22.ProductDetailRepositoryImpl(gh<_i12.ProductDetailService>()));
    gh.factory<_i23.ProductsRepository>(
        () => _i23.ProductsRepositoryImpl(gh<_i13.ProductsService>()));
    gh.factory<_i24.SignInRepository>(
        () => _i24.SignInRepositoryImpl(gh<_i15.SignInService>()));
    gh.factory<_i25.BulkAddCubit>(
        () => _i25.BulkAddCubit(gh<_i20.MarketListInteractor>()));
    gh.factory<_i26.DepartmentRepository>(
        () => _i26.DepartmentRepositoryImpl(gh<_i16.DepartmentService>()));
    gh.factory<_i27.MarketListAddBloc>(
        () => _i27.MarketListAddBloc(gh<_i20.MarketListInteractor>()));
    ...
    gh.factory<_i31.MarketListViewInteractor>(() =>
        _i31.MarketListViewInteractorImpl(gh<_i21.MarketListViewRepository>()));
    gh.factory<_i32.ProductDetailInteractor>(() =>
        _i32.ProductDetailInteractorImpl(gh<_i22.ProductDetailRepository>()));
    gh.factory<_i33.ProductsInteractor>(
        () => _i33.ProductsInteractorImpl(gh<_i23.ProductsRepository>()));
    gh.factory<_i34.SignInInteractor>(
        () => _i34.SignInInteractorImpl(gh<_i24.SignInRepository>()));
    gh.factory<_i35.DepartmentInteractor>(
        () => _i35.DepartmentInteractorImpl(gh<_i26.DepartmentRepository>()));
    gh.factory<_i36.MarketListDetailCubit>(() =>
        _i36.MarketListDetailCubit(gh<_i29.MarketListDetailInteractor>()));
    gh.factory<_i37.MarketListViewBloc>(
        () => _i37.MarketListViewBloc(gh<_i31.MarketListViewInteractor>()));
    gh.factory<_i38.ProductDetailBloc>(
        () => _i38.ProductDetailBloc(gh<_i32.ProductDetailInteractor>()));
    gh.factory<_i39.ProductsBloc>(
        () => _i39.ProductsBloc(gh<_i33.ProductsInteractor>()));
    gh.factory<_i40.SignInBloc>(() => _i40.SignInBloc(
          gh<_i3.RouteList>(),
          gh<_i34.SignInInteractor>(),
        ));
    gh.factory<_i41.DepartmentBloc>(
        () => _i41.DepartmentBloc(gh<_i35.DepartmentInteractor>()));
    return this;
  }
}
...
class _$NoAuthNetworkModule extends _i43.NoAuthNetworkModule {}
